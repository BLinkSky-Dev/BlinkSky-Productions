  ...
  return (
    <section id="top" className="relative min-h-[100svh] w-full overflow-hidden">
      ...
      <div className="container-x relative flex min-h-[100svh] flex-col justify-center pt-28 pb-16">
        ...
        >
          BlinkSky Productions shoots weddings, bridal portraits, casual shoots, model portfolios, clothing lookbooks and birthdays. Every image is made to be worth holding onto.
        </motion.p>
